 ...
 * just set properties on the response (like `status`, `contentType`, 
...
/* Response.__defaultContentType
 * 
 * If `response.contentType` isn't set, this value is used
 */
 ...
 * `null`, `Response.__defaultContentType` is used.
 */
 ...
 * `Response.prototype.contentType` and that return value is used.  
 */
 ...
 * `Response.prototype.contentType` and `Response.prototype.charset` to set the
 * Content-Type header.
 */
