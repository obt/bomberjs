...
var Server = exports.Server = function(app) {
  ...
  if (!this.base.server_config.signing_secret) {
    ...
    // set a random signing secret
    this.base.server_config.signing_secret = sha1.hex_hmac_sha1(Math.random(), Math.random());
  }

  process.mixin(this.options, this.base.server_config);
