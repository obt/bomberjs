 ...
 * with extension/mimetypes added from felixge's 
 *   node-paperboy: http://github.com/felixge/node-paperboy
 */
var mime = exports.mime = {
  lookup: function(filename, fallback) {
    return mime.types[path.extname(filename)] || fallback || mime.default_type;
  },
...
exports.require_resolve = function require_resolve(module_name) {
  var fs = process.fs;
