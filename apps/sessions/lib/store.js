...
var DirectoryStore = exports.DirectoryStore = function (location) {
    ...
    var createLocation = function () {
        fs.mkdir(location, 0700).wait();
    };
   
    var createReadmeFile = function () {
        var fd =
            fs.open(readmePath, process.O_CREAT | process.O_WRONLY, 0644)
            .wait();
        fs.write(fd,
    ...
    var assertNamespace = function (namespace) {
        ...
        try {
            try {
                nameStats = fs.stat(nameFile).wait();
            } catch (e) {
            ...
            stats = fs.stat(namespacePath).wait();
            ...
            fs.mkdir(namespacePath, 0700).wait();
        }
    ...
    var atomicWrite = function(filename, value, mode) {
        ...
        openPromise.addCallback(function(fd) {
            ...
            writePromise.addErrback(function(e) {
                ...
                // wait
                var writeFailPromise = fs.close(fd);
